...
%% python active_inference_basic.py --seed 1234 --mode m1_goal_error_1d --numsteps 200 --model knn --environment pointmass1d --goal_sample_interval 200
...
%% python active_inference_basic.py --seed 1236 --mode m1_goal_error_1d --numsteps 200 --model soesgp --environment pointmass1d --goal_sample_interval 200 
\begin{figure}
  \begin{center}
  \subfigure[System sweep response]{
...
%% python active_inference_basic.py --seed 1234 --mode m1_goal_error_1d --numsteps 1000 --model knn --environment pointmass1d --goal_sample_interval 100
\begin{figure}
  \begin{center}
  \subfigure[System sweep response]{
...
%% python active_inference_basic.py --seed 1237 --mode m1_goal_error_1d --numsteps 1000 --model soesgp --environment pointmass1d --goal_sample_interval 100
\begin{figure}
  \begin{center}
  \subfigure[System sweep response]{
